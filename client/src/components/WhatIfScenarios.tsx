          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-background rounded-lg border">
              ...
              <span className="text-xs px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-md font-medium">
                Save ${Math.round(coffeePerWeek * 5.50 * 4.33)} = {calculateImpact(coffeePerWeek * 5.50 * 4.33).daysSaved} days or {calculateImpact(coffeePerWeek * 5.50 * 4.33).percentCloser}% to goal<sup>1</sup>
              </span>
            </div>
            <div className="flex items-center justify-between p-3 bg-background rounded-lg border">
              <div className="flex items-center gap-3">
              ...
              <span className="text-xs px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-md font-medium">
                Save ${Math.round(lunchPerWeek * 15 * 4.33)} = {calculateImpact(lunchPerWeek * 15 * 4.33).daysSaved} days or {calculateImpact(lunchPerWeek * 15 * 4.33).percentCloser}% to goal<sup>1</sup>
              </span>
            </div>
            <div className="flex items-center justify-between p-3 bg-background rounded-lg border">
              <div className="flex items-center gap-3">
              ...
              <span className="text-xs px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-md font-medium">
                Save ${Math.round(streamingServices * 15)} = {calculateImpact(streamingServices * 15).daysSaved} days or {calculateImpact(streamingServices * 15).percentCloser}% to goal<sup>1</sup>
              </span>
            </div>
            <div className="flex items-center justify-between p-3 bg-background rounded-lg border">
              <div className="flex items-center gap-3">
              ...
              <span className="text-xs px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-md font-medium">
                Save ${Math.round(nightsOutPerMonth * 50)} = {calculateImpact(nightsOutPerMonth * 50).daysSaved} days or {calculateImpact(nightsOutPerMonth * 50).percentCloser}% to goal<sup>1</sup>
              </span>
            </div>
